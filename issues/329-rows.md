...
- Docs: `docs/wiki/rows.md`, README and `docs/wiki/packages.md` rows (thirteen packages after the merge with Shimmer, registration table), `agent-skills.md`, `/spine-controls` skill; `Spine.slnx`, `Spine.Packages.slnf`.
