...
/// <see cref="Color"/> is an extension member here instead of a member of the type. It does not
/// collide with the <see cref="System.Drawing.Color"/> overload on the type: nothing converts
/// between the two, so each call resolves to exactly one of them.
/// </summary>
