...
/// <see cref="EndpointRouteBuilderExtensions.MapSpinePushNotifications"/>, and an Azure Functions isolated worker
...
/// </remarks>
public static class SpinePushNotificationsEndpoints
{
    ...
    public static async Task<IResult> HandleAsync(HttpRequest request, CancellationToken cancellationToken = default)
    {
        ...
        var options = services.GetRequiredService<SpinePushNotificationsOptions>();
    ...
    internal static async Task<IResult> UpsertAsync(
        HttpRequest request, IPushInstallationStore store, SpinePushNotificationsOptions options, string id, CancellationToken cancellationToken)
    {
