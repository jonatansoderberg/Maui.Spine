...
/// <summary>
/// The one call Spine.PushNotifications needs before the app starts, on iOS and Mac Catalyst.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public static unsafe class SpinePushNotifications
{
    ...
    public static void Install(string appDelegateClassName = "AppDelegate")
    {
        ...
        if (cls == IntPtr.Zero)
        {
            throw new InvalidOperationException(
                $"Spine.PushNotifications: no Objective-C class named '{appDelegateClassName}'. Pass the name the app's " +
