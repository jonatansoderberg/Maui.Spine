...
/// <summary>Talks to the backend's <c>MapSpinePushNotifications</c> endpoints.</summary>
    ...
    HttpClient? httpClient = null)
{
        ...
        HttpMethod method, string installationId, HttpContent? content, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            logger.LogWarning("Spine.PushNotifications: the backend answered {Status} to {Method} {Path}.",
        ...
        catch (Exception e) when (e is not OperationCanceledException)
        {
            ...
            logger.LogDebug(e, "Spine.PushNotifications: could not reach the backend.");
            return false;
        }
    }
}
