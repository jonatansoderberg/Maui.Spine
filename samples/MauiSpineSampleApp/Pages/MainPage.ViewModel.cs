...
public partial class MainPageViewModel(INavigationService _navigation) : ViewModelBase
{
    ...
    [
        ...
        new("Scroll edge", "HeaderBarBackground.ScrollEdge: content under the header bar with the iOS 26 edge effect", "water.svg", "Plugin.Maui.Spine", n => n.NavigateToAsync<ScrollEdge.ScrollEdgePage>()),
        ...
        new("Calendar", "Month calendar with swipe, year and decade pickers, week numbers, theme and culture", "calendar.svg", "Plugin.Maui.Spine.Controls.Calendar", n => n.NavigateToAsync<Dates.DatesPage>()),
