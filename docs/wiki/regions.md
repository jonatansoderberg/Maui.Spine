...
- On iOS 26, `SoftEdge` over a photo already softens the photo's top at rest, as UIKit does for anything under the edge. Use `Transparent` or `Solid` for a photo page.
